...
Setting up the GitHub project board, Issues, and Milestones.
...
In regards to the created project Issues, we need to start assigning the tasks to each team member.

### Which features and user stories would you consider “at risk”? How will you change your plan if those items remain “at risk”?

The RSVP System and Authentication features are "at risk" due to both needing the frontend and backend integration. We will need to modify our plan to prioritize completing the core functionalities first.

### 5. What additional support will you need in upcoming units as you continue to work on your final project?

If possible, having time during class to work on the project. This would also ensure all team members are present to collaborate.
