  ...
  return (
    <>
      <article className='event-details-page'>
        <a href='/events' className='event-back-link'>⬅ Back to Events</a>
        ...
        <div className='event-details-sections'>
              ...
              <div className='host-container'>
                <div className='host'>
                  {event.organizer?.avatar_url ? (
                    <img src={event.organizer.avatar_url} alt={`${event.organizer?.first_name} ${event.organizer?.last_name}`} />
                  ) : (
          ...
          <section className='event-details-section rsvp'>
            ...
            <button type='button' className='rsvp-button'>Cancel RSVP</button>
          </section>
        </div>
      </article>
    </>
